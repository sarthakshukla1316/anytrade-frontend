    ...
    return (
        <Card className={classes.component}>
            ...
            <Box className={classes.rightComponent}>
                ...
                <Button onClick={() => {addItemToCart(item.id); removeItemFromWishlist(item.id);} } className={classes.remove}>Add to Cart</Button>

                <Button onClick={() => removeItemFromWishlist(item.id)} className={classes.remove}>Remove</Button>
            </Box>
        </Card>
    )
}
